...
# set uuid
wget -O /etc/xray/config.json https://raw.githubusercontent.com/LynzXvA/asu/main/config.json
clear
...
#nginx config
wget -O /etc/nginx/conf.d/xray.conf https://raw.githubusercontent.com/LynzXvA/asu/main/xray.conf
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green          Install SSH WEBS0CKET              	$NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
clear
cd
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/LynzXvA/asu/main/ws-stunnel
#izin permision
...
rm -fr menu
rm -fr /usr/sbin/menu
wget https://raw.githubusercontent.com/LynzXvA/asu/main/lynz.zip
unzip lynz.zip
rm -fr lynz.zip
clear
chmod +x *
